...
public class FluidSimulator
{
    ...
    void RunAdvect(PingPongRT target)
    {
        ...
        Graphics.Blit(null, target.Next, matAdvect);
        target.Swap();
    }
    ...
    void RunSplatVorticity()
    {
        ...
        Graphics.Blit(null, mgr.rtVelocity.Next, matSplatVorticity);
        mgr.rtVelocity.Swap();
    }
    ...
    void RunSplatDensity()
    {
        ...
        Graphics.Blit(null, mgr.rtDensity.Next, matSplatDensity);
        mgr.rtDensity.Swap();
    }
    ...
    void RunDivergence()
    {
        ...
        Graphics.Blit(null, mgr.rtDivergence, matDivergence);
    }
    ...
    void RunJacobi()
    {
        ...
        for (int i = 0; i < param.jacobiIterations; i++)
        {
            ...
            Graphics.Blit(null, mgr.rtPressure.Next, matJacobi);
            mgr.rtPressure.Swap();
        }
    }
    ...
    void RunSubtractGradient()
    {
        ...
        Graphics.Blit(null, mgr.rtVelocity.Next, matSubtractGradient);
        mgr.rtVelocity.Swap();
    }
